...
P202MainnetSetting = BaseChainSetting(NETWORK_NAME=P202MAINNET, GENESIS_FORK_VERSION=bytes.fromhex('00000202')) # P202_TODO
# Project202 Testnet setting
P202TestnetSetting = BaseChainSetting(NETWORK_NAME=P202TESTNET, GENESIS_FORK_VERSION=bytes.fromhex('00010202')) # P202_TODO
# Ropsten setting
